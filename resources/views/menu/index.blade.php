    ...
    <div class="flex w-10/12 m-auto items-center border border-gray-300 bg-white mb-4">
      ...
      <div class="flex justify-around w-3/4 p-10">
        <div class="leading-10">
          <h2 class="text-2xl text-gray-600 font-bold mb-2">Spicy beef burger</h2>
          <p class="leading-7 text-sm text-gray-400 mb-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repellendus placeat eaque minima culpa sit ducimus minus cum autem blanditiis optio, nesciunt obcaecati explicabo ea sint mollitia! Culpa sed alias quod.</p>
