<x-c.layout>
  <div class="text-center mt-10 mb-10 pb-5 pt-5">
    <div class="mb-10">
      @if ($mealsFrenchFries->count())
        <h2 class="leading-7 mb-2 text-2xl text-gray-600 font-semibold">Our French fries Meals For you!</h2>
        <div class="w-10/12 m-auto grid grid-cols-5 gap-4 mb-3">
          @foreach ($mealsFrenchFries as $meal)
      ...
      @else
        <div class="mt-20 mb-20 w-8/12 m-auto text-center">
          <h1 class="text-red-500 text-2xl font-bold">No French fries found for the moment!</h1>
